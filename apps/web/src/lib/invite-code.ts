 ...
 *
 * 정본은 [`docs/api/invite-v1.md`](../../../../docs/api/invite-v1.md) 다 — 형식·기한·시도 제한이
 * 거기 있고, 이 파일은 그 형식의 **클라이언트 쪽 절반**(정규화·표시)이다.
 * ⚠️ `api-interface-v1.html` §05 는 아직 `invite_url` 로 적혀 있지만 **그 파일은 갱신하지 않는다**
 *    (초기 프로토타입 시점의 글 · `docs/README.md`).
 *
