...
- [safety/personal-data-inventory-v1.md](safety/personal-data-inventory-v1.md) — 실제 수집·저장·전송 현황을 코드에서 뽑은 목록 · 보호자는 카카오 회원번호 1건, 아이는 별명·생일·관계 · IP·접속기록 수집 0건 · 외부 전송 3곳(발화 원문 · 급식표 사진 원본 · 카카오 자격증명) · Elice 뒤 수신자는 미확인 · 고지 누락 3건(장소 · 동반자 · 기관명)
- [safety/privacy-decisions-v1.md](safety/privacy-decisions-v1.md) — 처리방침 전에 닫아야 할 결정 6건과 선택지별로 잠기는 기능 · 국외 이전은 제28조의8 ③호로 처리방침 공개 갈음 가능 · 3-A(전달 범위) · 3-B(필수/선택 동의) · 4(법정대리인 확인, 배포 게이트) · 권고안과 권한 구분 · 생일은 일 단위 `date` 필수 (§10, 닫힘 2026-09-22)

*아직 문서 없음.* 가드레일 7개, 법정대리인 동의 절차 확정본. → [지금 열려 있는 결정](#지금-열려-있는-결정-기한-있음)
