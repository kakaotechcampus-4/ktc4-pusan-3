...
- [safety/privacy-decisions-v1.md](safety/privacy-decisions-v1.md) — 처리방침 전에 닫아야 할 결정 6건과 선택지별로 잠기는 기능 · 국외 이전은 제28조의8 ③호로 처리방침 공개 갈음 가능 · 3-A(전달 범위) · 3-B(필수/선택 동의) · 4(법정대리인 확인, 배포 게이트) · 권고안과 권한 구분
